...
export const Footer = () => {
  return (
    <footer id="contact" className="bg-[#222222] w-screen px-10 pt-20 pb-32 flex justify-center items-start" style={{ borderTopLeftRadius: '3vh', borderTopRightRadius: '3vh' }}>
