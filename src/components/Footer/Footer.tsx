...
export const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-[#222222] w-screen px-10 pt-[8rem] pb-32 flex justify-center items-start" style={{ borderTopLeftRadius: '3vh', borderTopRightRadius: '3vh' }}>
    ...
    <h2 className="text-4xl font-semibold text-[#A98C53] uppercase tracking-widest ml-5">Let&apos;s talk</h2>
        ...
        <Image alt="FB" src={hoverFB ? FBColor : FB} width={100} height={100} style={imageStyle(hoverFB)} /> </a>
        <a href="#" onMouseEnter={() => setHoverIG(true)} onMouseLeave={() => setHoverIG(false)}>
        <Image alt="IG" src={hoverIG ? IGColor : IG} width={100} height={100} style={imageStyle(hoverIG)}  /></a>
        <a href="#" onMouseEnter={() => setHoverLinkedIn(true)} onMouseLeave={() => setHoverLinkedIn(false)}>
        <Image alt="LinkedIn" src={hoverLinkedIn ? LinkedInColor : LinkedIn} width={100} height={100} style={imageStyle(hoverLinkedIn)} /></a>
        <a href="#" onMouseEnter={() => setHoverX(true)} onMouseLeave={() => setHoverX(false)}>
        <Image alt="X" src={hoverX ? XColor : X} width={100} height={100} style={imageStyle2(hoverX)}  /></a>
