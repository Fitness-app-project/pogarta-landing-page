...
export const Screen2 = () => {
    return (
        <div className="w-screen h-[20vh] flex flex-col items-center z-1">            <div className="w-screen flex justify-evenly text-white bg-[#000000] bg-opacity-10 h-[230px] z-1 ">
